...
\textit{\textit{\textit{\textit{\emph{Contract, Remote}}} \hfill \textit{\textit{\textit{\textit{\emph{Aug. 2024 - Current}}}
...
\textit{\textit{\textit{\textit{\emph{6mo. Contract, Remote}}} \hfill \textit{\textit{\textit{\textit{\emph{Jan. 2024 - Jul. 2024}}}
...
\textit{\textit{\textit{\textit{\emph{12mo. Contract, Remote}}} \hfill \textit{\textit{\textit{\textit{\emph{Jan. 2023 - Jan. 2024}}}
...
\textit{\textit{\textit{\textit{\emph{Full-Time, Sandpoint, ID}}} \hfill \textit{\textit{\textit{\textit{\emph{Jan. 2019 - Jan. 2023}}}
...
\textbf{\textbf{\textbf{\textbf{Languages}}}: Python, R, Scala, SAS, Matlab  
\textbf{\textbf{\textbf{\textbf{databases}}}: Snowflake, Redshift, PostgreSQL, MySQL, NoSQL, DynamoDB, Aurora, RDS  
\textbf{\textbf{\textbf{\textbf{Data Engineering Tools}}}: Airflow, dbt, Git, GitHub, Snowpipe, Docker, Kubernetes, Databricks  
\textbf{\textbf{\textbf{\textbf{data Visualization}}}: Tableau, Looker, PowerBI, Matplotlib, Seaborn  
\textbf{\textbf{\textbf{\textbf{cloud and DevOps}}}: GCP (Google cloud Platform), AWS (Amazon Web Services), Microsoft Azure, Databricks, Docker, Kubernetes, SageMaker  
\textbf{\textbf{\textbf{\textbf{Frameworks and Libraries}}}: Pandas, NumPy, Sci-kit learn (SciPy), TensorFlow, PyTorch, XGBoost, LightGBM, CatBoost, Matplotlib, Seaborn  
\textbf{\textbf{\textbf{\textbf{Big data Technologies}}}: Apache Spark, PySpark, Hadoop, Hive, Pig  
\textbf{\textbf{\textbf{\textbf{cloud Services}}}: Pub/Sub, datastream, Vertex AI, Google Kubernetes Engine (GKE), Snowpipe, AWS Batch, AWS data Pipeline, EC2, Kinesis, Elasticache, SageMaker, Docker
